...
// Métodos
    ...
    public static void auxValorExtenso(double valor, String[] vetor, String[] vNomClasse, String vExtenso) {
...
//        }  // Final Loop
    ...
    public static String valorExtenso(double valor){
        ...
        auxValorExtenso(valor, vetor, vNomClasse, vExtenso);
...
//		 ----------------------------------------------------------;
    ...
    */
     ...
     */
     ...
     public static HashMap<String,Estatistica> lerArquivoObjetosHashMap(String nomeArquivo) throws Exception {
    	 HashMap<String, Estatistica> listaObjetos = null;
         try {
             ObjectInputStream in = new ObjectInputStream(new FileInputStream(nomeArquivo));
              listaObjetos = (HashMap<String, Estatistica>)in.readObject(); // Ler os objetos e carregar na lista
             in.close();
         } catch (ClassNotFoundException errObj1) {
             throw errObj1;
   ...
   public static void gravarArquivoObjetosHashMap(String nomeArquivo, HashMap<String,Estatistica> listaObjetos) throws Exception {
    try {
          ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream(nomeArquivo));
          out.writeObject(listaObjetos);  // Gravar todos os objetos da lista
          out.close();
   ...
   /**
    * @method Coloca String dentro do objeto Date
    * Lucas B
    * @param fieldData
    * @return Data
    */
   public static Date obterData(String fieldData) {
	...
	/**
	 * @lucasB
	 * @method Retorna data Formatada em String
	 * @param data
	 * @return String data
	 */
	...
	/**
	 * @method retorna Data object
	 * @param data String
	 * @return Date
	 */
	public static Date obterStringParaData(String data) {
		
		
		SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
		
		
		Date dataFomated = null;
		try {
			
			dataFomated = formato.parse(data);
			
		} catch (ParseException e) {
			System.out.println("Erro de data String não correta "+ e.getMessage());
		}
	 ...
	 * 
	 * @param letra 
	 * @return primeira letra maiúscula e o resto minuscula
	 */
	public static String firstToUppercase(String letra) {
		
		return Character.toUpperCase(letra.charAt(0)) + letra.substring(1).toLowerCase();
	}
