...
//			data[i][5] = LtpLib.obterDataFormatada(listaProdutos.get(i).getDataCadastrada());
	...
	public Object[][] extendTabelaEstatistica(Date dataInicio,Date dataFinal) {
		...
		return extendTabelaEstatisticaIncrement(listaEstatisticas, listaEstatisticaPeriodo);
	}
	
	
	public Object[][] extendTabelaEstatisticaIncrement(HashMap<String, Estatistica> listaEstatisticas, HashMap<String, Estatistica> listaEstatisticaPeriodo) {
