...
//		  table.setModel(dataModel);
	...
	public Object[][] extendTabelaEstatistica(Date dataInicio,Date dataFinal) {
		...
		return extendTabelaEstatisticaIncrement(listaCompraPeriodo);
	}
	
	
	public Object[][] extendTabelaEstatisticaIncrement (ArrayList<Compra> listaCompraPeriodo) {
		//Create Table
	...
	public DefaultTableModel mostraTabelaCompra(Date dataInicio,Date dataFinal) throws SisComException {
		...
		Object[][] data = extendTabelaEstatistica(dataInicio, dataFinal);
		Object[] titleRow = {"Numero da Compra","Fornecedor","Data das vendas"};
	 ...
	 */
	public Object[][] extendTabelaEstatistica2(Date dataInicio,Date dataFinal) {
		...
		return extendTabelaEstatisticaIncrement2(listaEstatisticas, listaEstatisticaPeriodo);
	}
	
	
	public Object[][] extendTabelaEstatisticaIncrement2(HashMap<String, Estatistica> listaEstatisticas, HashMap<String, Estatistica> listaEstatisticaPeriodo) {
	...
	public DefaultTableModel mostraTabelaEstatistica(Date dataInicio,Date dataFinal) throws SisComException {
		...
		Object[][] data = extendTabelaEstatistica2(dataInicio, dataFinal);
		Object[] titleRow = {"Nome","Quantidade de vendas","Valor das vendas"};
	...
	public void fazerCompra(JLabel valorCompraTotal) {
		...
		if(tableFornecedor.getValueAt(0, 0).toString().trim() != null
			...
			try {
				...
				for(int i = 0; i <= 5; i++) {
					objFornecedor[i] = tableFornecedor.getValueAt(0, i).toString().trim();
				}
