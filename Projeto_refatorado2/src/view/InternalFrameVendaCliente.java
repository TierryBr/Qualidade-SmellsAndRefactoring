...
public class InternalFrameVendaCliente extends JInternalFrame {
	...
	private Fornecedor modelFornecedor = new Fornecedor();
...
//		atualizarValorCompra(lblValorTotalCompra);TODO
	...
	public void fazerVenda() {
		...
		try {
			...
			modelFornecedor.atualizarEstatistica(new Estatistica(vendedor.getNome(), 1, valorProdutosTotal,new Date()));
			
			modelCliente.atualizarEstatisticaCompraCliente(new Estatistica(cliente.getNome(), 1, valorProdutosTotal,new Date()));
