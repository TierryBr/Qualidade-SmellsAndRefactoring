...
public class Cliente extends Pessoa implements Serializable{
	...
	public double auxCompraCliente(Estatistica objEstatistica) {
		return objEstatistica.getValorTotal();
	}
	
	public void auxAtualizarEstatisticaCompraCliente(HashMap<String, Estatistica> listaEstatisticaCompras, Estatistica objEstatistica) {
		double total = auxCompraCliente(objEstatistica);
		listaEstatisticaCompras.get(objEstatistica.getNome()).incrementaValorTotal(total);
	}

	public void atualizarEstatisticaCompraCliente(Estatistica objEstatistica) {
		...
		if(listaEstatisticaCompras.isEmpty()) {	
			...
			auxAtualizarEstatisticaCompraCliente(listaEstatisticaCompras, objEstatistica);
		}
		else {
			listaEstatisticaCompras.put(objEstatistica.getNome(), objEstatistica);
		}
