...
public class Estatistica implements Serializable{
	...
	public double aux(Estatistica objEstatistica) {
		return objEstatistica.getValorTotal();
	}
	
	public void auxAtualizarEstatistica(HashMap<String, Estatistica> listaEstatisticaVendas, Estatistica objEstatistica) {
		double total = aux(objEstatistica);
		listaEstatisticaVendas.get(objEstatistica.getNome()).incrementaValorTotal(total);
	}
	...
	public void atualizarEstatistica(Estatistica objEstatistica) {
		...
		if(listaEstatisticaVendas.isEmpty()) {
			...
			auxAtualizarEstatistica(listaEstatisticaVendas, objEstatistica);
		}
		else {
			listaEstatisticaVendas.put(objEstatistica.getNome(), objEstatistica);
		}
