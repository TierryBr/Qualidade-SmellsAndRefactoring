...
public class Fornecedor extends Pessoa implements Serializable{
	...
	public void auxAtualizarEstatistica(HashMap<String, Estatistica> listaEstatisticaVenda, Estatistica objEstatistica) {
		double total = aux(objEstatistica);
		listaEstatisticaVenda.get(objEstatistica.getNome()).incrementaValorTotal(total);
	}
	...
	public void atualizarEstatistica(Estatistica objEstatistica) {
		...
		if(listaEstatisticaVenda.isEmpty()) {
			...
			auxAtualizarEstatistica(listaEstatisticaVenda, objEstatistica);
		}
		else {
			listaEstatisticaVenda.put(objEstatistica.getNome(), objEstatistica);
		}
