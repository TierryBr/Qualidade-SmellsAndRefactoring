			...
			public void keyReleased(KeyEvent e) {
				...
				if (e.getKeyCode() == KeyEvent.VK_ENTER){
					...
					try {
						...
						Produto produtos = (Produto) Produto.consultarProduto(Integer.parseInt(fieldPesquisar.getText()));
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					if(rdbtnOrdenarPorNome.isSelected()) {
						...
						produtos = Produto.obterListaProdutosEstoqueMin();
						Object[] colum = new Object[6];
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				int r = JOptionPane.showConfirmDialog(
					...
					try {
						...
						if(r  == 0) {
							Produto.removerProdutoId(idProduto);
